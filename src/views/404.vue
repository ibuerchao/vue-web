    ...
    c-11.4,0-20.6-9.2-20.6-20.6c0-11.4,9.2-20.6,20.6-20.6h21.2c11.4,0,20.6,9.2,20.6,20.6C353.3,177.9,344.1,187.1,332.8,187.1z"/>
        ...
        <div class="txtbg404">
            <div class="txtbox">
                ...
                <p>》<a href="https://blog.buerchao.top">返回网站首页</a></p>
            </div>
        </div>
    </div>
</template>
...
<style scoped>
    ...
    .txtbg404 .txtbox{ width:390px; position:relative; top:30px; left:60px;color:#3c3c3c; font-size:13px;}

    .txtbg404 .txtbox p {margin:5px 0; line-height:18px;}

    .txtbg404 .txtbox .paddingbox { padding-top:15px;}

    .txtbg404 .txtbox p a { color:#3c3c3c; text-decoration:none;}
