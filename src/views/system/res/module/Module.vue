<template>
    <el-scrollbar>
        <el-form :inline="true" class="demo-form-inline">
            <el-form-item>
                <el-input v-model="name" placeholder="输入模块名称搜索" size="small" clearable></el-input>
            </el-form-item>
            <el-form-item>
        ...
        <Detail :visible="visible" :form="form" :disabled="disabled" :title="title" :modules="modules" :create="create" :oldParentId="oldParentId"
...
<script>
  ...
  import {list,detail,del,superior,add,edit,updateStatus,up,down} from '@/api/module';
  import Detail from "@/views/system/res/module/detail";
